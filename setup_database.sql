...
INSERT INTO manufacturers (name, user_id) VALUES 
('Kenner', (SELECT id FROM auth.users LIMIT 1)),
('Hasbro', (SELECT id FROM auth.users LIMIT 1)),
('Mattel', (SELECT id FROM auth.users LIMIT 1)),
('LEGO', (SELECT id FROM auth.users LIMIT 1)),
('Playmobil', (SELECT id FROM auth.users LIMIT 1));
